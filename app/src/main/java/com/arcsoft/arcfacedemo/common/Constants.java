...
public class Constants {
    ...
    public static final String APP_ID = "4nsbp9vUN9rqKHqL1aE65Z3fwGhCHXads6QNAYzyQLMK";
    public static final String SDK_KEY = "GMhfddZSK5Mb66NN8Ctgozcis41ffL3uHKrypyA9Rrk4";
